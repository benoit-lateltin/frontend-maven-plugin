...
public final class FrontendPluginFactory {
    ...
    public VoltaInstaller getVoltaInstaller(ProxyConfig proxy) {
        return new VoltaInstaller(getInstallConfig(), new DefaultArchiveExtractor(), new DefaultFileDownloader(proxy));
    }
